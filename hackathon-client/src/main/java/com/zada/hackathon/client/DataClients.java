...
public class DataClients {
  ...
  private final Gson gson = new Gson(); // thread safe
   ...
   public KeywordResponse searchKeyword(KeywordRequest req) throws ClientException {
        ...
        for (int i = 0; i < TRY_COUNT; i++) {
            try {
                ...
                KeywordResponse resp = client.client.searchKeyword(req);
